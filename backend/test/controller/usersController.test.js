...
describe("usersController", () => {
    ...
    describe("login", () => {
        ...
        it("should return token on successful login", async () => {
            ...
            expect(res.send.calledWith({ success: true, token: "fakeToken" }))
                .to.be.true;
        });
        ...
        it("should return error if an error occurs during login", async () => {
            ...
            ).to.be.true; // Expect response to contain an error message
        });
    });
