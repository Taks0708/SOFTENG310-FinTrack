...
describe("securePassword", () => {
    ...
    describe("hashPassword", () => {
        ...
        it("should return an error if hashing fails", async () => {
            ...
            sinon
                .stub(bcrypt, "hash")
                .rejects(new Error("error hashing password"));
            const password = "password";
            try {
        ...
        it("should return a hashed password as a different string", async () => {
            ...
            const hashedPassword = await securePassword.hashPassword(
                plainPassword
            );
    ...
    describe("comparePasswords", () => {
        ...
        it("should return true if password matches hash", async () => {
            ...
            const isMatch = await securePassword.comparePasswords(
                password,
                hash
            );
        ...
        it("should return an error if comparison fails", async () => {
            ...
            sinon
                .stub(bcrypt, "compare")
                .rejects(new Error("Error comparing passwords"));
            const password = "password";
        ...
        it("should return true for matching passwords", async () => {
            ...
            const result = await securePassword.comparePasswords(
                plainPassword,
                hashedPassword
            );
